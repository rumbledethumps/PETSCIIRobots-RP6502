...
MAGN4:	;Collision with robot detected.
	...
	PHX ; backup X as PLAY_DIGI_SOUND will clobber it...
	TAX
	LDA #SFX_MAGNET
	CPX #21 ; crazy robot AI? IF so use SFX_MAGNET2, else SFX_MAGNET
	BEQ MAGN5
	LDA #SFX_MAGNET2
MAGN5:
	JSR PLAY_DIGI_SOUND
...
HOAT20:	JSR	ROBOT_ATTACK_RANGE
	...
	LDA	#SFX_SHOCK		;electric shock
	JSR	PLAY_DIGI_SOUND	;SOUND PLAY
	LDX	UNIT
	LDA	#37		;rate of attack on player.
	STA	UNIT_TIMER_A,X
...
EVIL20:	JSR	ROBOT_ATTACK_RANGE
	...
	JSR	INFLICT_DAMAGE
	JSR	CREATE_PLAYER_EXPLOSION
	LDA	#SFX_SHOCK		;electric shock sound
	JSR	PLAY_DIGI_SOUND	;SOUND PLAY
	LDX	UNIT
	LDA	#18		;rate of attack on player.
	STA	UNIT_TIMER_A,X
